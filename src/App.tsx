...
export default function App() {
  ...
  return (
    ...
    >
      {/* Sidebar - Inputs */}
      <aside className="w-full md:w-[320px] bg-bg-surface border-b md:border-b-0 md:border-r border-border-dim flex flex-col p-6 flex-shrink-0 shadow-sm z-20 relative">
            ...
            >
              <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-8 mb-10">
                <div className="space-y-3">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black text-text-bright tracking-tight max-w-2xl uppercase italic leading-tight">
                    {decision}
                  </h2>
                </div>
