      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={cn(
              "absolute z-999 px-2.5 py-1.5 shadow-xl bg-text-bright text-bg-base rounded-md text-[10px] font-black tracking-widest uppercase whitespace-nowrap pointer-events-none before:content-[''] before:absolute",
