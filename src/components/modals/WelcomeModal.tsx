        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-text-main font-semibold opacity-80">
              Stop guessing and start deciding. Let our powerful AI analysis engine help you make the best choice!
            </p>
          </div>
          ...
          <div className="w-full space-y-3 text-left bg-bg-base/50 p-6 rounded-2xl border border-border-dim">
            ...
            <div className="flex items-center gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent text-bg-surface flex items-center justify-center text-xs font-black">2</span>
              <span className="text-sm font-bold text-text-main">Add optional comparison factors</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent text-bg-surface flex items-center justify-center text-xs font-black">3</span>
