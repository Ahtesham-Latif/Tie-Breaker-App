    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8 mt-2">
          <div className="inline-flex px-3 py-1 bg-accent/10 text-accent rounded-full text-[10px] font-black uppercase tracking-widest mb-4 border border-accent/20">
            Limit Reached
          </div>
        ...
        <div className="bg-bg-panel border-2 border-amber-500/30 rounded-2xl p-6 mb-8 relative overflow-hidden shadow-[0_0_20px_rgba(245,158,11,0.05)]">
          <div className="absolute top-0 right-0 bg-amber-500 text-bg-surface px-4 py-1 rounded-bl-xl font-black uppercase tracking-widest text-[10px] shadow-sm flex items-center gap-1.5">
          ...
          <div className="flex items-baseline gap-2 mb-6 flex-wrap">
            ...
            <span className="ml-2 text-[10px] font-black text-amber-600 uppercase tracking-widest bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">
              (Free for now!)
            </span>
          </div>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-3 text-sm font-bold text-text-main">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-3.5 bg-accent text-bg-surface rounded-xl font-black uppercase tracking-widest text-sm shadow-xl shadow-accent/30 flex items-center justify-center gap-2 group"
        >
          <Zap size={18} className="group-hover:animate-pulse" /> Claim Free Pro Access
        </motion.button>
        
        <p className="text-center mt-4 text-[10px] font-bold text-text-dim uppercase tracking-widest opacity-60">
